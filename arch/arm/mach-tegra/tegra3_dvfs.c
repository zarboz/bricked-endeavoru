...
static struct dvfs cpu_dvfs_table[] = {
	...
	CPU_DVFS("cpu_g",  4, 0, MHZ,   1,   1, 550, 550,  680,  680,  820,  970, 1100, 1150, 1200, 1240, 1280, 1320, 1360, 1500, 1600, 1700),
	CPU_DVFS("cpu_g",  4, 1, MHZ,   1,   1, 650, 650,  780,  780,  990, 1040, 1100, 1200, 1250, 1300, 1330, 1360, 1400, 1500, 1600, 1700),
	CPU_DVFS("cpu_g",  4, 2, MHZ,   1,   1, 700, 700,  860,  860, 1050, 1150, 1200, 1280, 1300, 1340, 1380, 1500, 1600, 1700),
	CPU_DVFS("cpu_g",  4, 3, MHZ,   1,   1, 770, 770,  910,  910, 1150, 1230, 1280, 1330, 1370, 1400, 1500, 1600, 1700),
